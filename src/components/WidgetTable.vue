<template>
  <div class="widget-form-container">
    <div v-if="data.list.length == 0" class="form-empty">{{$t('tb.description.containerEmpty')}}</div>
      ...
      >
        ...
        <transition-group name="fade" tag="div" class="widget-form-list">
          <template v-for="(element, index) in data.list">
            ...
            <template v-else>
              <widget-table-item v-if="element && element.key"  :key="element.key" :element="element" :select.sync="selectWidget" :index="index" :data="data"></widget-table-item>
            </template>
          </template>
        </transition-group>
      </draggable>
