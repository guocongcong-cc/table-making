/**
 * Describe this is the utillty tools
 * Created by gcc on 2020-6-29.
 */
...
* n:要生成的随机字符串位数
* */
export const createRandomStr = (n) => {
...
* 返回中文金额大写
* */
export const amountToWords = (number) => {
    var ret = "";
...
export const amountnNumberFormat = (number, decimals, dec_point, thousands_sep) => {
