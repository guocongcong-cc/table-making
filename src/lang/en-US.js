  ...
  tb: {
    components: {
      fields: {
        ...
        divider: 'Divider',
        easyTable: 'EditTable',
        elBaseTable: 'BaseTable',
        elTreeTable: 'TreeTable',
        elMltipleTable: 'MltipleTable'
      },
      basic: {
    ...
    config: {
      ...
      widget: {
        title: 'Theader Attribute',
        tableAttr: 'Table property',
        tableStyle: 'Table style',
        theaderStyle: 'Theader style',
        background: "BackGround color",
        fontSize: 'Font size',
        fontColor: 'Font color',
        theaderHeight: 'Theader height',
        newColunmAttr: 'New column property',
        columnName: "Column name",
        dataName: "Data name",
        dataType: "Data type",
        numberFormat: 'Number format',
        thousandSymbol: 'Thousand symbol',
        ...
        longTip: 'Tip',
        addColumn: 'Add',
        selectTip: 'Please click a colmun',
        editColumn: 'Edit current column',
        submit: 'Submit',
        ...
        isBorder: "Display border",
        isStripe: 'Display zebra stripes',
        yes: 'Yes',
        no: 'No',
        dateTime: 'Date time',
        custom: 'Cutom',
